...
class XGBDropout(nn.Module):
    ...
    def fetch_gbdt(self, save_path, dataset):
        ...
        from models.tmlp.utils.model_utils import load_config_from_file
        configs = load_config_from_file(r'D:\DeepLearning\DeepLearningProject\models\tmlp\configs\default\xgboost.yaml')
